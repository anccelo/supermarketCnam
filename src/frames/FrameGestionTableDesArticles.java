...
//deve dinventae FrameGest....61
public class FrameGestionTableDesArticles extends JFrame
implements InterfaceGestion<TableArticles, TableDesCommandes,TableDesFactures> {
	...
	TableArticles tabArt ;
	TableDesCommandes tabCmd;
	

//************************************  CONSTRUCTOR  ************************************************
	
    public FrameGestionTableDesArticles(String nomPhisique){
 ...
 //************************************ METHODES  ************************************************   
     ...
     //on remplace le menu generale par un frame 
	public void menuGeneral (TableArticles tabArt, TableDesCommandes tabCmd, TableDesFactures tabNull)  throws  AbandonException, ErreurSaisieException
	{
		...
		creer.addActionListener((ActionListener) this);
		this.add(creer);
		
		afficher.addActionListener((ActionListener) this);
		this.add(afficher);
		
		fin.addActionListener((ActionListener) this);
		this.add(fin);
	...
	public void actionPerformed(ActionEvent evt) throws AbandonException, ErreurSaisieException{
		
		if(evt.getSource() == creer){
				try{
					creer(tabArt, tabCmd, null);
				}catch (Exception e){}
		}
	...
	/*	
		...
		do {
			...
			switch (choix) {
				case 1:creer(tabArt, tabCmd); break;
